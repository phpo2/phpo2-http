...
use PHPO2\Http\Interfaces\ResponseInterface;
...
class Response implements ResponseInterface
{
    ...
    /**
     * List of all response status code and text
     *
     * @var array
     */
    private $statusTexts = [
    ...
    /**
     * Return the request line and headers
     *
     * @return mixed
     */
    ...
    /**
     * Return the request cookie headers
     *
     * @return mixed
     */
